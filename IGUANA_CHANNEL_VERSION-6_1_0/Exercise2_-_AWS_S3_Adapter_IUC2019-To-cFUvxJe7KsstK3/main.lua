...
-- in which it is used.
--
-- This new version of the module enables Iguana to upload, download(read) and delete files from AWS S3.
--
-- Version:1.0
...
function main(Data)
   ...
   local fileName = 'yourfirstname'
   local folderName = 'yourlastname'
   local endpoint = '/'..folderName..'/'..fileName..'.txt'
